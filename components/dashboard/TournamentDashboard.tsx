...
interface TournamentDashboardProps {
    ...
    onAddFixture?: (fixture: Partial<MatchFixture>) => void; // NEW: Manual fixture creation
    allOrganizations?: Organization[]; // For fetching affiliated teams
    embedMode?: boolean; // NEW: If true, hides header and tabs
    initialTab?: TrnTab; // NEW: Start at specific tab
}
...
export const TournamentDashboard: React.FC<TournamentDashboardProps> = ({
    ...
    onAddGroup, onUpdateGroupTeams, onViewTeam, onViewMatch, onAddFixture, allOrganizations = [],
