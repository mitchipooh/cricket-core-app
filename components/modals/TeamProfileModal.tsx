...
export const TeamProfileModal: React.FC<TeamProfileModalProps> = ({ 
  team, isOpen, onClose, allFixtures, onViewPlayer, isFollowed, onToggleFollow, onViewMatch 
}) => {
            ...
            {activeTab === 'OVERVIEW' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white text-slate-900 p-8 rounded-[2.5rem] shadow-xl">
                        <h3 className="text-xl font-black mb-4">Team Bio</h3>
                        <p className="text-sm text-slate-600 leading-relaxed font-medium">{team.name} plays out of {team.location}. Currently managed by {team.management}. This squad features {team.players.length} registered players.</p>
